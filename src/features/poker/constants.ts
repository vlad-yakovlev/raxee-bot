...
export const pokerMessages = {
  ...
  start: {
    help: md.join([
      ...
      md`Для начала изучи правила: ${md.link('Техасский холдем', 'https://ru.wikipedia.org/wiki/%D0%A2%D0%B5%D1%85%D0%B0%D1%81%D1%81%D0%BA%D0%B8%D0%B9_%D1%85%D0%BE%D0%BB%D0%B4%D0%B5%D0%BC')}. Присутствуют некоторые некритичные отличия, сыграй несколько раундов и тебе будет понятно`,
